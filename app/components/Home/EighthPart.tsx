    ...
    <>
      <div className="px-3 w-full bg-white pt-8 lg:pt-10 pb-10 lg:pb-11 text-slate-800">
        <div className="max-w-6xl mx-auto flex flex-col gap-8">
          ...
          <div className="lg:mt-3 py-8 lg:p-10 px-4 md:px-8 lg:p-6 bg-[#f15e00] text-white rounded-3xl flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-0">
            ...
            <div className="w-full flex justify-center lg:justify-between lg:w-1/2 lg:flex-shrink-0">
              ...
              <div className="flex justify-center items-center w-full">
                <button className="cursor-pointer text-center font-bold text-[17px] w-full md:w-auto text-[#f15e00] bg-white px-4 py-3 md:px-12 lg:px-6 md:text-xl lg:py-2 hover:bg-gray-100 hover:duration-300 hover:ease-in-out rounded-xl" onClick={handleTop}>Commencer mon devis</button>
              </div>
            </div>
          </div>
        </div>

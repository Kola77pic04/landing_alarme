            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-3 gap-3 lg:gap-2">
                    {types.map((type, index) => (
                        <div key={index} className={`lg:h-40 relative flex-1 flex flex-col lg:justify-center items-center gap-2 p-4 rounded-lg border cursor-pointer ${position === index ? "border-[#f15e00] bg-[#f15e00]/5" : "bg-white border-slate-200"}`} onClick={() => handleSelect(index, type.label)}>

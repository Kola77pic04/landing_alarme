            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 gap-3 lg:gap-2.5">
                    {equipments.map((equipment, index) => (
                        <div key={index} className={`relative flex-1 flex items-center gap-2 p-4 lg:py-4.5 rounded-lg border cursor-pointer ${position === index ? "border-[#e4464e] bg-[#e4464e]/5" : "bg-white border-slate-200"}`} onClick={() => handleSelect(index, equipment.label)}>
